...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Submit jobs for Dirichlet energy extraction."
    )
    parser.add_argument("run_path", help="Path to the run directory")
    args = parser.parse_args()
    
    # like
    # runs/gen_msrp_fe/run1/task33/powerflownet/
    # print(args.run_path)

    submit_jobs(args.run_path)
