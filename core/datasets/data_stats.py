...
pfnet_pfdata_stats = {
    ...
    "case14_30_57": {
        "casename": "case14_30_57",
        "mean": {
            "bus": {
                "y": torch.tensor([0.9878, -0.3533, 0.2799, 0.1355, 0.0000, 0.0064])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0702, 0.2248, 0.0121, 0.9941, 0.0000])
            },
        },
        "std": {
            "bus": {
                "y": torch.tensor([0.0572, 0.2870, 1.2275, 0.4735, 0.0000, 0.0294])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0959, 0.2436, 0.0222, 0.0194, 0.0000])
            },
        },
    },
    "case118_500": {
        "casename": "case118_500",
        "mean": {
            "bus": {
                "y": torch.tensor([1.0829, -0.5584, 0.5059, 0.1802, 0.0000, 0.0239])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0114, 0.0623, 0.0260, 1.0044, 0.0000])
            },
        },
        "std": {
            "bus": {
                "y": torch.tensor([0.0346, 0.5953, 1.5880, 0.6694, 0.0000, 0.3139])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0177, 0.2367, 0.0893, 0.0145, 0.0000])
            },
        },
    },
    "case30_57_118": {
        "casename": "case30_57_118",
        "mean": {
            "bus": {
                "y": torch.tensor([1.0115, -0.5179, 0.4131, 0.2145, 0.0000, 0.0065])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0447, 0.1545, 0.0486, 0.9964, 0.0000])
            },
        },
        "std": {
            "bus": {
                "y": torch.tensor([0.0503, 0.3457, 2.0011, 0.6664, 0.0000, 0.0490])
            },
            ("bus", "branch", "bus"): {
                "edge_attr": torch.tensor([0.0685, 0.1822, 0.1424, 0.0150, 0.0000])
            },
        },
    },
    "case57_118_500": {
        "casename": "case57_118_500",
        "mean": {
            "bus": {
                "y": torch.tensor([1.0115, -0.5179, 0.4131, 0.2145, 0.0000, 0.0065])
            },
