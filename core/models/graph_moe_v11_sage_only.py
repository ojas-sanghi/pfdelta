...
@registry.register_model("graph_moe_v11_sage_only")
class GraphMoeV11SageOnly(nn.Module):
    """graph_moe_v11_sage_only: auto-generated MoE variant for systematic experimentation."""
