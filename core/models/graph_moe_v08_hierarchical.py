...
@registry.register_model("graph_moe_v08_hierarchical")
class GraphMoeV08Hierarchical(nn.Module):
    """graph_moe_v08_hierarchical: auto-generated MoE variant for systematic experimentation."""
