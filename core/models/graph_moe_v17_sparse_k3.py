...
@registry.register_model("graph_moe_v17_sparse_k3")
class GraphMoeV17SparseK3(nn.Module):
    """graph_moe_v17_sparse_k3: auto-generated MoE variant for systematic experimentation."""
