...
@registry.register_model("graph_moe_v05_dense_gate")
class GraphMoeV05DenseGate(nn.Module):
    """graph_moe_v05_dense_gate: auto-generated MoE variant for systematic experimentation."""
