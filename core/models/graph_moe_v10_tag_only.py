...
@registry.register_model("graph_moe_v10_tag_only")
class GraphMoeV10TagOnly(nn.Module):
    """graph_moe_v10_tag_only: auto-generated MoE variant for systematic experimentation."""
