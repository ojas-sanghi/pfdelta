...
@registry.register_model("graph_moe_v14_size_temp_low")
class GraphMoeV14SizeTempLow(nn.Module):
    """graph_moe_v14_size_temp_low: auto-generated MoE variant for systematic experimentation."""
