...
@registry.register_model("graph_moe_v06_noisy_topk")
class GraphMoeV06NoisyTopk(nn.Module):
    """graph_moe_v06_noisy_topk: auto-generated MoE variant for systematic experimentation."""
