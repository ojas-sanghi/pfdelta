...
@registry.register_model("graph_moe_v20_hier_gumbel")
class GraphMoeV20HierGumbel(nn.Module):
    """graph_moe_v20_hier_gumbel: auto-generated MoE variant for systematic experimentation."""
