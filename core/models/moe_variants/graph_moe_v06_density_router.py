"""Auto-registered MoE variant: graph_moe_v06_density_router."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v06_density_router")
class GraphMoeV06DensityRouter(GraphMoEBackbone):
    """graph_moe_v06_density_router variant with explicit fixed defaults."""
