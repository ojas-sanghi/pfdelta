"""Auto-registered MoE variant: graph_moe_v04_expert_dropout."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v04_expert_dropout")
class GraphMoeV04ExpertDropout(GraphMoEBackbone):
    """graph_moe_v04_expert_dropout variant with explicit fixed defaults."""
