"""Auto-registered MoE variant: graph_moe_v10_tag_experts."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v10_tag_experts")
class GraphMoeV10TagExperts(GraphMoEBackbone):
    """graph_moe_v10_tag_experts variant with explicit fixed defaults."""
