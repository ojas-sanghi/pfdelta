"""Auto-registered MoE variant: graph_moe_v08_strong_prior."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v08_strong_prior")
class GraphMoeV08StrongPrior(GraphMoEBackbone):
    """graph_moe_v08_strong_prior variant with explicit fixed defaults."""
