"""Auto-registered MoE variant: graph_moe_v11_nnconv_experts."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v11_nnconv_experts")
class GraphMoeV11NnconvExperts(GraphMoEBackbone):
    """graph_moe_v11_nnconv_experts variant with explicit fixed defaults."""
