"""Auto-registered MoE variant: graph_moe_v20_adaptive_confidence."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v20_adaptive_confidence")
class GraphMoeV20AdaptiveConfidence(GraphMoEBackbone):
    """graph_moe_v20_adaptive_confidence variant with explicit fixed defaults."""
