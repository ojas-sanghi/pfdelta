"""Auto-registered MoE variant: graph_moe_v02_size_dense."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v02_size_dense")
class GraphMoeV02SizeDense(GraphMoEBackbone):
    """graph_moe_v02_size_dense variant with explicit fixed defaults."""
