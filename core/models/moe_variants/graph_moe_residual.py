...
@registry.register_model("graph_moe_residual")
class GraphMoEResidual(nn.Module):
    """Sparse MoE with residual skip from encoded node representation."""
    ...
    def forward(self, data: HeteroData) -> Tensor:
        ...
        return (y * sparse.unsqueeze(-1)).sum(1) + self.skip(h)
