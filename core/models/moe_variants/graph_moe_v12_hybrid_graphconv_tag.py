"""Auto-registered MoE variant: graph_moe_v12_hybrid_graphconv_tag."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v12_hybrid_graphconv_tag")
class GraphMoeV12HybridGraphconvTag(GraphMoEBackbone):
    """graph_moe_v12_hybrid_graphconv_tag variant with explicit fixed defaults."""
