"""Auto-registered MoE variant: graph_moe_v03_noisy_topk."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v03_noisy_topk")
class GraphMoeV03NoisyTopk(GraphMoEBackbone):
    """graph_moe_v03_noisy_topk variant with explicit fixed defaults."""
