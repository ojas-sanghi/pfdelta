"""Auto-registered MoE variant: graph_moe_v09_sage_experts."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v09_sage_experts")
class GraphMoeV09SageExperts(GraphMoEBackbone):
    """graph_moe_v09_sage_experts variant with explicit fixed defaults."""
