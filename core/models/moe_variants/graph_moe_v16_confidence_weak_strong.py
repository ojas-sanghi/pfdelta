"""Auto-registered MoE variant: graph_moe_v16_confidence_weak_strong."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v16_confidence_weak_strong")
class GraphMoeV16ConfidenceWeakStrong(GraphMoEBackbone):
    """graph_moe_v16_confidence_weak_strong variant with explicit fixed defaults."""
