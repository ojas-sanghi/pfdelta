"""Auto-registered MoE variant: graph_moe_v01_size_topk."""

from core.utils.registry import registry
from core.models.moe_backbones import GraphMoEBackbone


@registry.register_model("graph_moe_v01_size_topk")
class GraphMoeV01SizeTopk(GraphMoEBackbone):
    """graph_moe_v01_size_topk variant with explicit fixed defaults."""
