...
@registry.register_model("graph_moe_v15_size_temp_high")
class GraphMoeV15SizeTempHigh(nn.Module):
    """graph_moe_v15_size_temp_high: auto-generated MoE variant for systematic experimentation."""
