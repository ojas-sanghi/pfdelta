...
@registry.register_model("graph_moe_v09_hop_mixed")
class GraphMoeV09HopMixed(nn.Module):
    """graph_moe_v09_hop_mixed: auto-generated MoE variant for systematic experimentation."""
