...
@registry.register_model("graph_moe_v16_sparse_k1")
class GraphMoeV16SparseK1(nn.Module):
    """graph_moe_v16_sparse_k1: auto-generated MoE variant for systematic experimentation."""
