...
@registry.register_model("graph_moe_v12_weak_strong")
class GraphMoeV12WeakStrong(nn.Module):
    """graph_moe_v12_weak_strong: auto-generated MoE variant for systematic experimentation."""
